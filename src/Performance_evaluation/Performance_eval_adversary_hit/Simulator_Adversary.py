...
class World(object):
    ...
    def adversary_initialization(self, spawn_point, spawn_points):
         ...
         n=np.random.randint(30,100)    #60  # Initialize adversary 60 waypoints ahead of the protagonist
...
def execute_DQN(args,DQNetwork, TargetNetwork, file_name=""):
   with tf.Session() as sess:
      ...
      # Load the model
      saver.restore(sess,file_name +".ckpt")
      path=file_name+ args.protagonist + ".txt"
      print(path)
    ...
    try:
       ...
       # world = World(client.get_world(), hud, args.filter)
        ...
        if use_model:
              ...
              performance_log.write('%f, %f, %f, %f' % (total_reward, MTTF, Hit, Collsion_intensity))         
...
def main():
    ...
    argparser.add_argument(
        ...
        metavar='model',
        default='alone',
        help='protagonist model (default: "alone")')
